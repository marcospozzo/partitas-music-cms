...
$(function () {
  $("#new-contributor").validate({
    ...
    submitHandler: function () {
      $.ajax({
        url: "https://partitasmusic.com/api/create-contributor",
        type: "POST",
        contentType: "application/json",
        headers: {
          // "Authorization": $('#tokenField').val()
          Authorization: "73bf7fb14111598e",
        },
        async: false,
      });
      //document.forms["new-contributor"].submit();
    },
  });
});
